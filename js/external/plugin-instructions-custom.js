var jsPsychInstructions = (function (jspsych) {
  ...
  const info = {
      ...
      parameters: {
          ...
          button_label_last: {
            type: jspsych.ParameterType.STRING,
            pretty_name: "Button label last",
            default: "Next",
          },
          button_label_last_background_color: {
            type: jspsych.ParameterType.STRING,
            pretty_name: "Button label last background color",
            default: "default"
          },
          button_label_last_font_color: {
            type: jspsych.ParameterType.STRING,
            pretty_name: "Button label last font color",
            default: "default"
          }
      },
  };
      ...
      trial(display_element, trial) {
          ...
          function show_current_page() {
              ...
              if (trial.show_clickable_nav) {
                  ...
                  let last_html = "<button id='jspsych-instructions-next' class='jspsych-btn'" +
                        "style='margin-left: 5px;'>" +
                        trial.button_label_next +
                        " &gt;</button></div>";

                  if(current_page === trial.pages.length-1){
                    let bg = (trial.button_label_last_background_color === "default")?"":("background-color: " + trial.button_label_last_background_color + "; ")
                    let fc = (trial.button_label_last_font_color === "default")?"":("color: " + trial.button_label_last_font_color + "; ")

                      last_html =   "<button id='jspsych-instructions-next' class='jspsych-btn'" +
                            "style='margin-left: 5px;" + bg + fc + "'>" +
                            trial.button_label_last +
                            " &gt;</button></div>";

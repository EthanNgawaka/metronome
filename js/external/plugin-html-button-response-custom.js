      ...
      trial(display_element, trial) {
          ...
          for (var i = 0; i < trial.choices.length; i++) {
              display_element
                  ...
                  var choice_content =   btn_el.textContent
                      after_response(choice, choice_content);
              });
          }
          // store response
          var response = {
          ...
          function after_response(choice, choice_content) {
              // measure rt
              var end_time = performance.now();
              var rt = Math.round(end_time - start_time);
              response.button = parseInt(choice);
              response.rt = rt;
              response.response_content = choice_content
